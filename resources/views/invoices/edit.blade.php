                    ...
                    <form action="{{ route('invoices.update', $invoice) }}" method="post" autocomplete="off">
                            ...
                            <div class="col">
                                ...
                                <select name="section_id" class="form-control SelectBox" onclick="console.log($(this).val())"
                                    ...
                                    @foreach ($sections as $section)
                                        <option value="{{ $section->id }}" @selected($invoice->section_id == $section->id)> {{ $section->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <select name="rate_vat" id="rate_vat" class="form-control" onclick="myFunction()">
                                    <!--placeholder-->
                                    <option value="5%" @selected($invoice->rate_vat == "5%")>5%</option>
                                    <option value="10%" @selected($invoice->rate_vat == "10%")>10%</option>
                                </select>
                            </div>
...
@section('js')
    ...
    <script>
        $(document).ready(function() {
            $('select[name="section_id"]').on('click', function() {
